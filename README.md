...
3. The app will be available at http://localhost (nginx on port 80) and static files are served by nginx. Note: the project files live under `01-todo/` in this repository, so use `cd 01-todo/zcamp` for direct manage.py commands.
